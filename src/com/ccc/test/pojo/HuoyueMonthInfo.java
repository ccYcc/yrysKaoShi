 ...
 */
@Entity
@Table(name = HuoyueMonthInfo.TABLE_NAME)
public class HuoyueMonthInfo implements Serializable{

	private static final long serialVersionUID = 1L;

	public static final String TABLE_NAME = "tb_huoyue_month_statistic";
